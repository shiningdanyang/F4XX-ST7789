...
//	ST7789_WriteString(10, 50, "Hello Duongw!", &Font_7x10, RED, WHITE);
//	ST7789_WriteString(10, 75, "Hello Duongw!", &Font_11x18, YELLOW, WHITE);
//	ST7789_WriteString(10, 100, "Hello Duongw!", &Font_16x26, MAGENTA, WHITE);
//	HAL_Delay(1000);
//
//	ST7789_Fill_Color(RED);
...
//	ST7789_Fill_Color(WHITE);
	ST7789_DrawImage(0, 0, 24, 17, (uint16_t *)iconBattery);
	HAL_Delay(3000);
}
